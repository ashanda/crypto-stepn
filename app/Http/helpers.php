  ...
  function assign_user_commissions($user_package_row_id,$package_value,$package_id,$package_cat,$current_user,$package_cat_id){
    ...
    while ( $virtual_parentid  != 1){// ID 2 is the top most user in the pyramid.*/ 
     ...
     //finding the direct parent chain
      if($parent_id == $direct_parent_dna){
  ...
  foreach($User_packages_details as $package){
   ...
   // Update user_packages table total 
        ...
        user_package_total_binary($User_packages_details[0]->id ,$User_packages_details[0]->uid,$package->package_max_revenue,$User_packages_details[0]->total,$current_right_balance);
            ...
            binary_commission_update_query($ref_s,$User_binary_details,$virtual_parentid,$current_row_uid,$balance_commission,$User_packages_details);
            
          }            
        }

      }elseif($package->package_max_revenue == $package->total){  
