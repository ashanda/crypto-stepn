                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right main-notification">
							<li class="nav-item dropdown notification_dropdown">
                                <a data-toggle="tooltip" data-placement="top" title="New KYC" class="nav-link  ai-icon" href="/kyc" role="button" data-toggle="dropdown">
                                   <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<span  class="badge light text-white bg-primary rounded-circle">{{ pendingKycCount() }}</span>
                                </a>
								
							</li>
							<li class="nav-item dropdown notification_dropdown">
                                <a data-toggle="tooltip" data-placement="top" title="New Package" class="nav-link  ai-icon" href="/user_buy_package" role="button" data-toggle="dropdown">
									<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<span class="badge light text-white bg-primary rounded-circle">{{ pendingPackageCount() }}</span>
                                </a>
