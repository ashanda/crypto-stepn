							...
							<div class="col-sm-6">
								<div class="card-bx stacked card">
									...
									<div class="card-info">
										...
										<div class="d-flex justify-content-between">
											<h2 class="num-text text-white mb-5 font-w600">My Reffrel Link Right Chain</h2>
					...
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<h2 class="text-black mb-2 font-w600">${{ number_format(Cryptocap::getSingleAsset('bitcoin')->data->priceUsd,2) }}</h2>
								<p class="mb-0 fs-13">
					...
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<h2 class="text-black mb-2 font-w600">${{ number_format(Cryptocap::getSingleAsset('ethereum')->data->priceUsd,2) }}</h2>
								<p class="mb-0 fs-14">
									<svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<h2 class="text-black mb-2 font-w600">${{ number_format(Cryptocap::getSingleAsset('solana')->data->priceUsd,2) }}</h2>
								<p class="mb-0 fs-14">
									<svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<h2 class="text-black mb-2 font-w600">${{ number_format(Cryptocap::getSingleAsset('cardano')->data->priceUsd,2) }}</h2>
								<p class="mb-0 fs-14">
									<svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div id="example4_wrapper" class="dataTables_wrapper no-footer">
                                        ...
                                        <thead>
                                            <tr role="row">
												...
												<th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" style="width: 102.3px;" aria-label="Student Name: activate to sort column ascending">Name</th>
												<th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" style="width: 112.067px;" aria-label="Invoice number: activate to sort column ascending">Price</th>
												<th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" style="width: 74.7px;" aria-label="Fees Type : activate to sort column ascending">24H % </th>
												<th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" style="width: 66px;" aria-label="Status : activate to sort column ascending">Marketcap </th>
												<th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" style="width: 74.7px;" aria-label="Fees Type : activate to sort column ascending">Volume(24h) </th>
												<th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" style="width: 74.7px;" aria-label="Fees Type : activate to sort column ascending">Circulating Supply </th>
											</tr>
                                        </thead>
                                        <tbody>  
											...
											<tr>
												...
												<td class='has-details'> <span class="details">Calcutale Supply - {{ number_format($data->supply,0) }}<br> Max Supply - {{ number_format($data->maxSupply,0) }}</span>{{ number_format($data->supply,0) }}<br><small>{{ number_format($data->maxSupply,0) }}</small></td>
											</tr>
										@endforeach                                          
